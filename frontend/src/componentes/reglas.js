function Reglas () {
    return(
        <div className="reglamento">
            ...
            <div>
            <h2 className="subt-reg">MICROFÚTBOL (FÚTBOL DE SALÓN)</h2><br />
            <h3 className="subt-reg">Reglamento:</h3>
            <h3 className="subt-reg">Adaptación en la institución educativa</h3>
            <p id="parrafo-galeria">En la institución educativa se maneja  el reglamento de microfútbol y no el de futbol sala, ya que las condiciones del polideportivo de la institución y el material del suelo no es el adecuado para el futbol sala, el tiempo que se maneja en los partidos amistosos si es el mismo y las demás reglas también.
            <br /> <br /> A continuación algunas reglas del micro fútbol: <br /><br /> 
                ...
                <b>10. </b>Distancia en los Tiros Libres: Los jugadores defensores deben estar a una distancia mínima de 5 metros del balón durante los tiros libres. <br />

            </p><br /> <br /> <br />
            </div>

            <div>
            <h2 className="subt-reg">BALONCESTO</h2><br />
            <h3 className="subt-reg">Reglamento:</h3>
            <h3 className="subt-reg">Adaptación en la institución educativa</h3>
            <p id="parrafo-galeria">En la institución educativa se maneja el reglamento del baloncesto en su totalidad en cuanto a la realización del juego, más que todo en la jornada de la mañana, en la jornada de la tarde se maneja el reglamento pero se perdonan  algunas faltas leves y movimientos inválidos, más que todo por la poca práctica de este deporte en dicha jornada, los mejores jugadores son enviados a entrenar en la jornada de la mañana para pulir sus habilidades y hacer parte de la selección de la institución educativa.<br />
            <br /> A continuación algunas reglas que se manejan en la institucion educativa: <br /><br />
                ...
                El equipo ganador conseguirá tres (3) puntos y el no ganador uno (1). <br />

            </p><br /> <br /> <br />
            </div>

            <div>
            <h2 className="subt-reg">VOLEIBOL</h2><br />
            <h3 className="subt-reg">Reglamento:</h3>
            <h3 className="subt-reg">Adaptación en la institución educativa</h3>
            <p id="parrafo-galeria">En la institución educativa se maneja el reglamento del baloncesto en su totalidad en cuanto a la realización del juego, más que todo en la jornada de la mañana, en la jornada de la tarde se maneja el reglamento pero se perdonan  algunas faltas leves y movimientos inválidos, más que todo por la poca práctica de este deporte en dicha jornada.
                <br /> <br /> Aquí encontraras algunas reglas importantes del voleibol:<br /> <br />
                ...
                <b>13. </b>El partido se juega en sets. Generalmente, se juega al mejor de cinco sets. Los primeros cuatro sets se juegan a 25 puntos y el quinto set (si es necesario) se juega a 15 puntos. Un equipo debe ganar por una diferencia de al menos dos puntos. <br />

                </p><br /> <br /> <br />
            </div>

            <div>
            <h2 className="subt-reg">AJEDREZ</h2><br />
            <h3 className="subt-reg">Reglamento:</h3>
            <h3 className="subt-reg">Adaptación en la institución educativa</h3>
            <p id="parrafo-galeria">El ajedrez es un deporte que no maneja una gran cantidad de reglas, más que todo se maneja una forma específica de mover y cumplir una función con las diferentes piezas que tienes para jugar. El objetivo de ambos jugadores es el mismo y el reglamento no tiene cambios.
                En la institución educativa se maneja la forma básica de jugar el ajedrez, sin contar con un límite de tiempo como se juega en los torneos de gran importancia y de un nivel mucho más avanzado, así se da más confianza y más tiempo para poder pensar los movimientos y las jugadas en un nivel básico y amateur.<br /> <br />
                A continuación, te enseñamos algunas de las reglas del ajedrez:  <br /><br />
                ...
                <b>10. </b>El rey: se mueve igual que la dama, en todas direcciones (columnas, filas y diagonales), pero sólo puede ir de una en una casilla, pudiendo ir también hacia delante y hacia atrás. La captura y demás aspectos son iguales que para las otras piezas. Sin embargo, tienes que saber que el rey nunca puede mover a una casilla donde lo puedan capturar, mientras que las otras piezas sí que pueden hacerlo si lo desean. Por tanto, un rey nunca podrá ocupar una casilla contigua al otro rey. <br />
